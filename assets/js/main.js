...
hoverChangeExperience(
  ".digitalhouse",
  ` ✓ Liderança no desenvolvimento de sites e landing pages.
  <br><br>
✓Liderei o desenvolvimento de um sistema de ensino para um Engenheiro e Professor da
Universidade Federal de Alagoas (UFAL). O sistema conta com cadastro de alunos, cadastro de
dúvidas do aluno, geração de usuários com nível Admin ou Estudante, pontuações e outras
funcionalidades. Laravel foi usado para o projeto.
 <br><br>
✓ Manutenção de um ERP WEB utilizando Laravel, Jquery e Blade.
  <br><br>
✓ Trabalhando no desenvolvimento de software de gestão de múltiplas fazendas agrícolas e
relatórios de colheita. Laravel e MySQL estão sendo usados;
<br><br>
✓ Trabalhando no desenvolvimento de um software gestão para clínicas odontológicas. Laravel e MySQL estão sendo usados;`,
  "Eduardo Marques",
...
hoverChangeExperience(
  ...
  `Samuel Eric
  UX/UI Designer
  ✓ Diretor Visual no desenvolvimento de sites e aplicativos
  <br><br>
  ✓Estive a frente no desenvolvimento visual de sistemas para pedidos em restaurantes, onde o intuito era construir uma interface prática tanto para o cliente quanto para o dono do estabelecimento, fácil acesso para interações e funções, mantendo a identidade visual e com boas interfaces.
  <br><br>
  ✓ Reconstrução de um layout completo para um site que se localiza em Portugal/Lisboa, envolvendo um Hotel 5 estrelas;
  <br><br>
  ✓ Trabalhando no desenvolvimento de sistemas Web, WebSites, Product Design.
  <br><br>
  ✓ Trabalhando no desenvolvimento do Sistema Web "Alvo Certo", uma empresa de Tips Esportivas.`,
  "Samuel Eric",
  "UX/UI Designer",
